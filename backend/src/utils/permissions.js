...
const READ_PERMISSIONS = {
  ...
  categories: [ADMIN, PAO, STORE_HEAD, STOCK_CLERK],
  items: [ADMIN, PAO, STORE_HEAD, STOREKEEPER, STOCK_CLERK],
  'goods-receipts': [ADMIN, STORE_HEAD, STOREKEEPER, TEC, SECURITY],
  'stock-transactions': [ADMIN, PAO, STORE_HEAD, STOREKEEPER, STOCK_CLERK, ACCOUNTANT],
  'bin-cards': [ADMIN, PAO, STORE_HEAD, STOREKEEPER, STOCK_CLERK],
  'bin-transfers': [ADMIN, PAO, STORE_HEAD, STOREKEEPER, STOCK_CLERK],
  requisitions: [ADMIN, PAO, STORE_HEAD, DEPT_HEAD, STOREKEEPER],
  'issue-vouchers': [ADMIN, STORE_HEAD, STOREKEEPER, SECURITY],
  'material-returns': [ADMIN, STORE_HEAD, DEPT_HEAD, TEC],
  'material-transfers': [ADMIN, PAO, STORE_HEAD, DEPT_HEAD, SECURITY],
  'fixed-assets': [ADMIN, PAO, STORE_HEAD],
  disposals: [ADMIN, PAO, STORE_HEAD],
  users: [ADMIN],
  'audit-logs': [ADMIN, PAO, ACCOUNTANT, SECURITY],
  reports: [ADMIN, PAO, ACCOUNTANT, STORE_HEAD, STOCK_CLERK, TEC, DEPT_HEAD],
...
const WRITE_PERMISSIONS = {
  ...
  'bin-cards': [ADMIN, PAO, STORE_HEAD, STOREKEEPER, STOCK_CLERK],
  requisitions: [ADMIN, PAO, DEPT_HEAD], // Store Head approves via /approve; Storekeeper: read-only
  'issue-vouchers': [ADMIN, STORE_HEAD, STOREKEEPER],
  'material-returns': [ADMIN, STORE_HEAD, DEPT_HEAD], // TEC: read-only unless doing the evaluation route
...
module.exports = { ROLES, READ_PERMISSIONS, WRITE_PERMISSIONS, canRead, canWrite };
