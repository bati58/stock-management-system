...
export const ROLE_PERMISSIONS = {
    [ROLES.ADMIN]: {
        ...
        canCreate: ['stores', 'categories', 'items', 'users', 'suppliers', 'departments', 'locations', 'fixedAssets'],
        canEdit: ['stores', 'categories', 'items', 'users', 'suppliers', 'departments', 'locations', 'fixedAssets'],
        canDelete: ['stores', 'categories', 'items', 'users', 'suppliers', 'departments', 'locations'],
        canApprove: [],
        canReject: [],
        canEvaluate: [],
    ...
    [ROLES.PAO]: {
        ...
        canDelete: [],
        canApprove: ['requisitions', 'materialReturns', 'disposals', 'stockTransfer', 'materialTransfers'],
        canReject: ['requisitions', 'materialReturns', 'disposals', 'stockTransfer', 'materialTransfers'],
        canEvaluate: [],
        canVerifyGatePass: false,
        canAddUsers: false,
